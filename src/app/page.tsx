...
export default function Home() {
  ...
  if (showLanding) {
    return (
      <div
        className={`landing-page fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden bg-[#0e1525] ${
          landingFading ? "fade-out" : ""
        }`}
      >
        {/* 배경 — 중앙 비네트 그라디언트 */}
        <div className="absolute inset-0 pointer-events-none" style={{
          background: 'radial-gradient(ellipse 80% 70% at 50% 50%, rgba(26,39,68,0.3) 0%, transparent 60%)'
        }} />
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="landing-particle landing-particle-1 absolute w-[3px] h-[3px] rounded-full bg-gold/20" style={{ left: '15%', bottom: '-5%' }} />
          <div className="landing-particle landing-particle-2 absolute w-[2px] h-[2px] rounded-full bg-gold/25" style={{ left: '30%', bottom: '-8%' }} />
          <div className="landing-particle landing-particle-3 absolute w-[3px] h-[3px] rounded-full bg-gold/18" style={{ left: '55%', bottom: '-3%' }} />
          <div className="landing-particle landing-particle-4 absolute w-[2px] h-[2px] rounded-full bg-gold/22" style={{ left: '72%', bottom: '-6%' }} />
          <div className="landing-particle landing-particle-5 absolute w-[3px] h-[3px] rounded-full bg-gold/15" style={{ left: '88%', bottom: '-4%' }} />
          <div className="landing-particle landing-particle-6 absolute w-[2px] h-[2px] rounded-full bg-gold/20" style={{ left: '42%', bottom: '-7%' }} />
        </div>
        ...
        <div className="landing-side-text hidden md:flex absolute left-6 lg:left-10 top-1/2 -translate-y-1/2 z-10 pointer-events-none">
          <p className="text-white/[0.06] text-[9px] tracking-[0.4em] font-medium uppercase" style={{
        ...
        {/* 배경 원 — 바깥 */}
        <div className="landing-circle absolute top-1/2 left-1/2 w-[440px] h-[440px] md:w-[580px] md:h-[580px] lg:w-[660px] lg:h-[660px] rounded-full border border-white/[0.05] pointer-events-none">
        ...
        {/* 배경 원 — 안쪽 (점선) */}
        <div className="landing-circle-inner absolute top-1/2 left-1/2 w-[400px] h-[400px] md:w-[530px] md:h-[530px] lg:w-[610px] lg:h-[610px] rounded-full border border-dashed border-white/[0.03] pointer-events-none" />
        ...
        <div className="landing-diagonal absolute top-1/2 left-1/2 pointer-events-none" style={{
          ...
          background: 'linear-gradient(90deg, transparent 20%, rgba(201,169,110,0.06) 40%, rgba(201,169,110,0.06) 60%, transparent 80%)'
        }} />
        <div className="landing-diagonal absolute top-1/2 left-1/2 pointer-events-none" style={{
          width: '140%', height: '1px', transform: 'translate(-50%, -50%) rotate(-45deg)',
          background: 'linear-gradient(90deg, transparent 20%, rgba(201,169,110,0.06) 40%, rgba(201,169,110,0.06) 60%, transparent 80%)'
        ...
        <div className="landing-crossline absolute top-1/2 left-0 right-0 h-px pointer-events-none" style={{
          background: 'linear-gradient(90deg, transparent 5%, rgba(201,169,110,0.08) 30%, rgba(201,169,110,0.08) 70%, transparent 95%)'
        }} />
        <div className="landing-crossline absolute left-1/2 top-0 bottom-0 w-px pointer-events-none" style={{
          background: 'linear-gradient(180deg, transparent 5%, rgba(201,169,110,0.08) 30%, rgba(201,169,110,0.08) 70%, transparent 95%)'
        }} />
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6">
          ...
          <div className="landing-logo pointer-events-none mb-5 md:mb-7">
            <Image
              ...
              style={{ opacity: 0.25, filter: 'saturate(0.3) brightness(2)' }}
              priority
            />
          </div>
          ...
          <div className="landing-en-heading flex items-center gap-3 md:gap-4 mb-4 md:mb-5">
            <div className="w-6 md:w-10 h-px bg-white/[0.1]" />
            <p className="text-white/20 text-[8px] md:text-[10px] tracking-[0.5em] font-medium uppercase">
              JUNGANG HEIGHTS
            </p>
            <div className="w-6 md:w-10 h-px bg-white/[0.1]" />
          </div>
          ...
          {/* 메인 타이틀 — 큰 세리프 + 넓은 자간 */}
          <h1 className="landing-title text-white text-[32px] md:text-[48px] lg:text-[58px] font-light" style={{ fontFamily: "'Noto Serif KR', serif" }}>
            중 앙 하 이 츠
          </h1>

          {/* 골드 다이아몬드 장식 (트리플) */}
          <div className="landing-diamond flex items-center gap-2 md:gap-3 mt-4 md:mt-5">
            <div className="w-6 md:w-12 h-px bg-gold/25" />
            <div className="w-[4px] h-[4px] rotate-45 bg-gold/30" />
            <div className="w-3 md:w-5 h-px bg-gold/30" />
            <div className="w-[7px] h-[7px] rotate-45 border border-gold/45 landing-diamond-center" />
            <div className="w-3 md:w-5 h-px bg-gold/30" />
            <div className="w-[4px] h-[4px] rotate-45 bg-gold/30" />
            <div className="w-6 md:w-12 h-px bg-gold/25" />
          </div>
          ...
          <div className="landing-subtitle flex items-center gap-4 md:gap-6 mt-4 md:mt-5">
            <div className="flex items-center gap-1.5">
              ...
              <div className="w-16 md:w-24 h-px bg-gradient-to-r from-gold/15 via-gold/30 to-gold/40" />
            </div>
            <p className="text-gold/70 text-[13px] md:text-[16px] tracking-[0.35em]" style={{ fontFamily: "'Noto Serif KR', serif" }}>
              갈산역 센트럴
            </p>
            <div className="flex items-center gap-1.5">
              <div className="w-16 md:w-24 h-px bg-gradient-to-l from-gold/15 via-gold/30 to-gold/40" />
              <div className="w-1 h-1 rounded-full bg-gold/25" />
            </div>
          </div>

          {/* 한글 설명 */}
          <p className="landing-desc text-white/40 text-[12px] md:text-[14px] tracking-[0.08em] mt-8 md:mt-10" style={{ fontFamily: "'Noto Serif KR', serif" }}>
            갈산역 초역세권 · 수변공원 초공세권 · 총 126세대
          </p>

          {/* 영문 설명 */}
          <p className="landing-desc-en text-white/20 text-[8px] md:text-[10px] tracking-[0.3em] font-medium mt-2 uppercase">
          ...
          <div className="landing-enter mt-10 md:mt-14 relative">
            {/* 외곽 링 */}
            <div className="landing-enter-outer-ring absolute -inset-2 md:-inset-2.5 rounded-[60px] border border-white/[0.05] pointer-events-none" />
            <button
              onClick={handleEnter}
              className="group relative"
            >
              <div className="landing-enter-btn w-[260px] md:w-[340px] py-5 md:py-6 rounded-[50px] border border-white/15 text-white/40 text-[12px] md:text-[14px] tracking-[0.45em] font-medium transition-all duration-500 hover:border-gold/50 hover:text-gold flex items-center justify-center gap-3">
                <span>ENTER</span>
        ...
        <a
          href="tel:1800-5636"
          className="landing-phone absolute bottom-16 md:bottom-20 left-8 md:left-14 z-10 flex items-center gap-2.5 text-white/20 hover:text-gold transition-colors duration-300"
        >
        ...
        {/* 우하단 저작권 */}
        <p className="landing-copyright absolute bottom-16 md:bottom-20 right-8 md:right-14 z-10 text-white/10 text-[8px] md:text-[9px] tracking-[0.15em]">
        ...
        <div className="landing-footer absolute bottom-0 left-0 right-0 z-10">
          ...
          <div className="w-full h-px mt-px bg-gradient-to-r from-transparent via-white/[0.03] to-transparent" />
          <div className="py-4 md:py-5 flex items-center justify-center gap-4 md:gap-6 px-4">
            {landingKeywords.map((kw, i) => (
              <span key={i} className="flex items-center gap-4 md:gap-6">
                <span className="text-white/30 text-[9px] md:text-[10px] tracking-[0.2em] font-medium hover:text-gold/60 transition-colors duration-300 cursor-default">
                  {kw}
                </span>
