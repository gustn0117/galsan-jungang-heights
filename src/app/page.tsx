      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 w-full max-w-[1000px]">
          ...
          <div className="landing-en-heading mb-12 md:mb-16">
            <p className="text-navy/60 text-[16px] md:text-[22px] lg:text-[26px] tracking-[0.08em] font-light landing-fadeup" style={{ animationDelay: '0.3s' }}>
              &ldquo; 갈산역 「<span className="text-navy font-medium landing-highlight-pulse">0분</span>」의 가치, 걸어서 누리는 완성된 프리미엄 &rdquo;
            </p>
          </div>
