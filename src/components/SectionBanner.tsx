  ...
  return (
    <div className={`relative h-[300px] overflow-hidden flex items-center justify-center ${!bgImage ? fallbackGradient : "bg-gray-900"}`}>
      ...
      <div className="relative z-10 text-center">
        <h2 className="banner-title-animate text-white text-[48px] md:text-[56px] font-bold tracking-[20px]" style={{ fontFamily: "'NanumSquare', sans-serif" }}>
          {title}
        </h2>
      </div>
      <p className="banner-sub-animate absolute bottom-8 text-white/60 text-[15px] md:text-[17px] text-center w-full z-10 tracking-wide" style={{ fontFamily: "'NanumSquare', sans-serif" }}>
        {subtitle}
      </p>
